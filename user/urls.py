...
## 회원가입/로그인 (Writer : Joe)
    ...
    # path('verification_sent', views.verification_sent_allauths, name=UserViewname.VIEW_VERIFICATION_SENT),
    path('password/change/', views.password_change_allauth, name="password_change"),
